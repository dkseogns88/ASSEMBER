...
struct FGradCharacterPartList
{
	...
	FGradCharacterPartList(UGradPawnComponent_CharacterParts* InOwnerComponent)
	...
	UPROPERTY()
	TObjectPtr<UGradPawnComponent_CharacterParts> OwnerComponent;
 ...
 */
UCLASS()
class GRADGAME_API UGradPawnComponent_CharacterParts : public UPawnComponent
{
	GENERATED_BODY()
public:
