...
bool FGradCharacterPartList::SpawnActorForEntry(FGradAppliedCharacterPartEntry& Entry)
{
	...
	if (Entry.Part.PartClass != nullptr)
	{
		...
		// GradPawnComponent_CharacterParts에 어느 Component에 붙일 것인지 결정한다: 
		...
		if (USceneComponent* ComponentToAttachTo = OwnerComponent->GetSceneComponentToAttachTo())
		{
			...
			{
				// 해당 Actor가 Parent인 GradPawnComponent_CharacterParts의 Owner Actor보다 먼저 Tick이 실행되지 않도록 선행조건을 붙인다
...
USkeletalMeshComponent* UGradPawnComponent_CharacterParts::GetParentMeshComponent() const
{
...
USceneComponent* UGradPawnComponent_CharacterParts::GetSceneComponentToAttachTo() const
{
...
FGameplayTagContainer UGradPawnComponent_CharacterParts::GetCombinedTags(FGameplayTag RequiredPrefix) const
{
...
void UGradPawnComponent_CharacterParts::BroadcastChanged()
{
...
FGradCharacterPartHandle UGradPawnComponent_CharacterParts::AddCharacterPart(const FGradCharacterPart& NewPart)
{
	return CharacterPartList.AddEntry(NewPart);
}

void UGradPawnComponent_CharacterParts::RemoveCharacterPart(FGradCharacterPartHandle Handle)
{
