...
PROTOBUF_CONSTEXPR ZoomInfo::ZoomInfo(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.object_id_)*/uint64_t{0u}
  , /*decltype(_impl_.b_zoom_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct ZoomInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ZoomInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ZoomInfoDefaultTypeInternal() {}
  union {
    ZoomInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ZoomInfoDefaultTypeInternal _ZoomInfo_default_instance_;
PROTOBUF_CONSTEXPR FireInfo::FireInfo(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.object_id_)*/uint64_t{0u}
  , /*decltype(_impl_.s_x_)*/0
  , /*decltype(_impl_.s_y_)*/0
  , /*decltype(_impl_.s_z_)*/0
  , /*decltype(_impl_.e_x_)*/0
  , /*decltype(_impl_.e_y_)*/0
  , /*decltype(_impl_.e_z_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct FireInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR FireInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~FireInfoDefaultTypeInternal() {}
  union {
    FireInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FireInfoDefaultTypeInternal _FireInfo_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::ZoomInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::ZoomInfo, _impl_.object_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ZoomInfo, _impl_.b_zoom_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.object_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.s_x_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.s_y_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.s_z_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.e_x_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.e_y_),
  PROTOBUF_FIELD_OFFSET(::Protocol::FireInfo, _impl_.e_z_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::PosInfo)},
  { 15, -1, -1, sizeof(::Protocol::ObjectInfo)},
  { 27, -1, -1, sizeof(::Protocol::ZoomInfo)},
  { 35, -1, -1, sizeof(::Protocol::FireInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Protocol::_PosInfo_default_instance_._instance,
  &::Protocol::_ObjectInfo_default_instance_._instance,
  &::Protocol::_ZoomInfo_default_instance_._instance,
  &::Protocol::_FireInfo_default_instance_._instance,
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "te\030\006 \001(\0162\023.Protocol.MoveState\022\013\n\003d_x\030\007 \001"
  "(\002\022\013\n\003d_y\030\010 \001(\002\022\013\n\003d_z\030\t \001(\002\"\366\001\n\nObjectI"
  "nfo\022\021\n\tobject_id\030\001 \001(\004\022)\n\013object_type\030\002 "
  "\001(\0162\024.Protocol.ObjectType\022-\n\rcreature_ty"
  "pe\030\003 \001(\0162\026.Protocol.CreatureType\022)\n\013play"
  "er_type\030\004 \001(\0162\024.Protocol.PlayerType\022+\n\014m"
  "onster_type\030\005 \001(\0162\025.Protocol.MonsterType"
  "\022#\n\010pos_Info\030\006 \001(\0132\021.Protocol.PosInfo\"-\n"
  "\010ZoomInfo\022\021\n\tobject_id\030\001 \001(\004\022\016\n\006b_zoom\030\002"
  " \001(\010\"k\n\010FireInfo\022\021\n\tobject_id\030\001 \001(\004\022\013\n\003s"
  "_x\030\002 \001(\002\022\013\n\003s_y\030\003 \001(\002\022\013\n\003s_z\030\004 \001(\002\022\013\n\003e_"
  "x\030\005 \001(\002\022\013\n\003e_y\030\006 \001(\002\022\013\n\003e_z\030\007 \001(\002b\006proto"
  "3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 601, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
...
uint8_t* ObjectInfo::_InternalSerialize(
  ...
  if (this->_internal_monster_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      5, this->_internal_monster_type(), target);
  }
...
class ZoomInfo::_Internal {
 public:
};

ZoomInfo::ZoomInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.ZoomInfo)
}
ZoomInfo::ZoomInfo(const ZoomInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ZoomInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.object_id_){}
    , decltype(_impl_.b_zoom_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.object_id_, &from._impl_.object_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.b_zoom_) -
    reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.b_zoom_));
  // @@protoc_insertion_point(copy_constructor:Protocol.ZoomInfo)
}

inline void ZoomInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ZoomInfo::~ZoomInfo() {
  // @@protoc_insertion_point(destructor:Protocol.ZoomInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ZoomInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void ZoomInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void ZoomInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.ZoomInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&_impl_.object_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.b_zoom_) -
      reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.b_zoom_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* ZoomInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.b_zoom_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ZoomInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.ZoomInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // bool b_zoom = 2;
  if (this->_internal_b_zoom() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_b_zoom(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.ZoomInfo)
  return target;
}

size_t ZoomInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.ZoomInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ZoomInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ZoomInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ZoomInfo::GetClassData() const { return &_class_data_; }


void ZoomInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ZoomInfo*>(&to_msg);
  auto& from = static_cast<const ZoomInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.ZoomInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_b_zoom() != 0) {
    _this->_internal_set_b_zoom(from._internal_b_zoom());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void ZoomInfo::CopyFrom(const ZoomInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.ZoomInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ZoomInfo::IsInitialized() const {
  return true;
}

void ZoomInfo::InternalSwap(ZoomInfo* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ZoomInfo, _impl_.b_zoom_)
      + sizeof(ZoomInfo::_impl_.b_zoom_)
      - PROTOBUF_FIELD_OFFSET(ZoomInfo, _impl_.object_id_)>(
          reinterpret_cast<char*>(&_impl_.object_id_),
          reinterpret_cast<char*>(&other->_impl_.object_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ZoomInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
class FireInfo::_Internal {
 public:
};

FireInfo::FireInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.FireInfo)
}
FireInfo::FireInfo(const FireInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  FireInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.object_id_){}
    , decltype(_impl_.s_x_){}
    , decltype(_impl_.s_y_){}
    , decltype(_impl_.s_z_){}
    , decltype(_impl_.e_x_){}
    , decltype(_impl_.e_y_){}
    , decltype(_impl_.e_z_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.object_id_, &from._impl_.object_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.e_z_) -
    reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.e_z_));
  // @@protoc_insertion_point(copy_constructor:Protocol.FireInfo)
}

inline void FireInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
FireInfo::~FireInfo() {
  // @@protoc_insertion_point(destructor:Protocol.FireInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void FireInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void FireInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void FireInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.FireInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&_impl_.object_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.e_z_) -
      reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.e_z_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* FireInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 21)) {
          _impl_.s_x_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 29)) {
          _impl_.s_y_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 37)) {
          _impl_.s_z_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 45)) {
          _impl_.e_x_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 53)) {
          _impl_.e_y_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 61)) {
          _impl_.e_z_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* FireInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.FireInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // float s_x = 2;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_x = this->_internal_s_x();
  uint32_t raw_s_x;
  memcpy(&raw_s_x, &tmp_s_x, sizeof(tmp_s_x));
  if (raw_s_x != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(2, this->_internal_s_x(), target);
  }

  // float s_y = 3;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_y = this->_internal_s_y();
  uint32_t raw_s_y;
  memcpy(&raw_s_y, &tmp_s_y, sizeof(tmp_s_y));
  if (raw_s_y != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(3, this->_internal_s_y(), target);
  }

  // float s_z = 4;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_z = this->_internal_s_z();
  uint32_t raw_s_z;
  memcpy(&raw_s_z, &tmp_s_z, sizeof(tmp_s_z));
  if (raw_s_z != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(4, this->_internal_s_z(), target);
  }

  // float e_x = 5;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_x = this->_internal_e_x();
  uint32_t raw_e_x;
  memcpy(&raw_e_x, &tmp_e_x, sizeof(tmp_e_x));
  if (raw_e_x != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(5, this->_internal_e_x(), target);
  }

  // float e_y = 6;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_y = this->_internal_e_y();
  uint32_t raw_e_y;
  memcpy(&raw_e_y, &tmp_e_y, sizeof(tmp_e_y));
  if (raw_e_y != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(6, this->_internal_e_y(), target);
  }

  // float e_z = 7;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_z = this->_internal_e_z();
  uint32_t raw_e_z;
  memcpy(&raw_e_z, &tmp_e_z, sizeof(tmp_e_z));
  if (raw_e_z != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(7, this->_internal_e_z(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.FireInfo)
  return target;
}

size_t FireInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.FireInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData FireInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    FireInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*FireInfo::GetClassData() const { return &_class_data_; }


void FireInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<FireInfo*>(&to_msg);
  auto& from = static_cast<const FireInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.FireInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_x = from._internal_s_x();
  uint32_t raw_s_x;
  memcpy(&raw_s_x, &tmp_s_x, sizeof(tmp_s_x));
  if (raw_s_x != 0) {
    _this->_internal_set_s_x(from._internal_s_x());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_y = from._internal_s_y();
  uint32_t raw_s_y;
  memcpy(&raw_s_y, &tmp_s_y, sizeof(tmp_s_y));
  if (raw_s_y != 0) {
    _this->_internal_set_s_y(from._internal_s_y());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_s_z = from._internal_s_z();
  uint32_t raw_s_z;
  memcpy(&raw_s_z, &tmp_s_z, sizeof(tmp_s_z));
  if (raw_s_z != 0) {
    _this->_internal_set_s_z(from._internal_s_z());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_x = from._internal_e_x();
  uint32_t raw_e_x;
  memcpy(&raw_e_x, &tmp_e_x, sizeof(tmp_e_x));
  if (raw_e_x != 0) {
    _this->_internal_set_e_x(from._internal_e_x());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_y = from._internal_e_y();
  uint32_t raw_e_y;
  memcpy(&raw_e_y, &tmp_e_y, sizeof(tmp_e_y));
  if (raw_e_y != 0) {
    _this->_internal_set_e_y(from._internal_e_y());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_e_z = from._internal_e_z();
  uint32_t raw_e_z;
  memcpy(&raw_e_z, &tmp_e_z, sizeof(tmp_e_z));
  if (raw_e_z != 0) {
    _this->_internal_set_e_z(from._internal_e_z());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void FireInfo::CopyFrom(const FireInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.FireInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool FireInfo::IsInitialized() const {
  return true;
}

void FireInfo::InternalSwap(FireInfo* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FireInfo, _impl_.e_z_)
      + sizeof(FireInfo::_impl_.e_z_)
      - PROTOBUF_FIELD_OFFSET(FireInfo, _impl_.object_id_)>(
          reinterpret_cast<char*>(&_impl_.object_id_),
          reinterpret_cast<char*>(&other->_impl_.object_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata FireInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::ZoomInfo*
Arena::CreateMaybeMessage< ::Protocol::ZoomInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::ZoomInfo >(arena);
}
template<> PROTOBUF_NOINLINE ::Protocol::FireInfo*
Arena::CreateMaybeMessage< ::Protocol::FireInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::FireInfo >(arena);
}
