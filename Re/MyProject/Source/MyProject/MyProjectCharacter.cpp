...
AMyProjectCharacter::AMyProjectCharacter()
{
	...
	CameraBoom1P->TargetArmLength = 300.f; // ī�޶�� �÷��̾� ������ �Ÿ�
	CameraBoom1P->bUsePawnControlRotation = true; // ������ ���� Pawn�� ��Ʈ�� ȸ���� �������� ����
	...
	FirstPersonCameraComponent1P->bUsePawnControlRotation = false; // ī�޶� ��ü ȸ���� ������� ����
